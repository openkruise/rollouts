...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkTrafficRouting) DeepCopyInto(out *NetworkTrafficRouting) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkTrafficRouting.
func (in *NetworkTrafficRouting) DeepCopy() *NetworkTrafficRouting {
	if in == nil {
		return nil
	}
	out := new(NetworkTrafficRouting)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TrafficRouting) DeepCopyInto(out *TrafficRouting) {
	*out = *in
	...
	if in.NetworkRefs != nil {
		...
		*out = make([]NetworkTrafficRouting, len(*in))
		copy(*out, *in)
	}
}
