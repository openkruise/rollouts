...
const (
	...
	WorkloadStillReconciling WorkloadEventType = "workload-is-still-reconciling"
...
// ReleaseController is the interface that all type of cloneSet controller implements
