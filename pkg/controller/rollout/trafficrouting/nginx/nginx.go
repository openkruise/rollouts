...
func (r *nginxController) Initialize(ctx context.Context) (bool, error) {
...
func (r *nginxController) VerifyRoutes(ctx context.Context, desiredWeight int32) (bool, error) {
